    ...
    pub fn builtin() -> Self {
        ...
        registry.register(ComponentSchema {
            ...
            fields: vec![
                ...
                field("surface_profile", ComponentFieldKind::String, "still"),
                field("wave_direction", ComponentFieldKind::Vec3, "1,0,0"),
                field("wave_amplitude", ComponentFieldKind::F32, "0"),
                field("wave_length", ComponentFieldKind::F32, "12"),
                field("wave_speed", ComponentFieldKind::F32, "2"),
                field("chop_amplitude", ComponentFieldKind::F32, "0"),
                field("chop_length", ComponentFieldKind::F32, "5"),
                field("river_slope", ComponentFieldKind::F32, "0"),
                field("tide_amplitude", ComponentFieldKind::F32, "0"),
                field("tide_period_seconds", ComponentFieldKind::F32, "44712"),
                field("tide_phase_seconds", ComponentFieldKind::F32, "0"),
                field("water_tint", ComponentFieldKind::Vec3, "0.05,0.32,0.42"),
                field("water_alpha", ComponentFieldKind::F32, "0.72"),
                field("reflection_strength", ComponentFieldKind::F32, "0.85"),
                field("fresnel_power", ComponentFieldKind::F32, "5"),
                field("reflection_roughness", ComponentFieldKind::F32, "0.06"),
                field(
                    "absorption_tint",
                    ComponentFieldKind::Vec3,
                    "0.04,0.18,0.22",
                ),
            ],
            evolution: SchemaEvolution::default(),
