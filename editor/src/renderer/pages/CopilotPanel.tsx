...
const sendButtonClass = 'flex h-7 w-7 flex-shrink-0 cursor-pointer items-center justify-center rounded-[var(--radius-sm)] border-0 bg-[var(--brand)] text-[var(--text-on-brand)] transition-[background] duration-[var(--transition-fast)] hover:not-disabled:bg-[var(--brand-hover)] disabled:cursor-default disabled:opacity-40';
